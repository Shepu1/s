...
window.addEventListener('DOMContentLoaded', async () => {
    ...
    if (aiAvatar) {
        aiAvatar.src = currentTheme === 'hacking-mode' ? "app/assets/hai.ico" : "app/assets/pai.png";
    }
...
function setHackingMode() {
    ...
    const aiAvatar = document.getElementById('ai-avatar');
    if (aiAvatar) {
        aiAvatar.src = document.body.classList.contains('hacking-mode') ? "app/assets/hai.ico" : "app/assets/pai.png";
    }
...
function toggleTheme() {
    ...
    const aiAvatar = document.getElementById('ai-avatar');
    if (aiAvatar) aiAvatar.src = "app/assets/pai.png";
}
...
function addMessage(text, sender) {
    ...
    let avatarHTML = sender === 'bot'
        ? `<img src="${document.body.classList.contains('hacking-mode') ? 'app/assets/hai.ico' : 'app/assets/pai.png'}" alt="AI" onerror="this.style.display='none';this.parentElement.innerHTML='<i class=\\'fas fa-robot\\'></i>'">`
...
function addTypingIndicator() {
    ...
    div.innerHTML = `
        <div class="avatar"><img src="${document.body.classList.contains('hacking-mode') ? 'app/assets/hai.ico' : 'app/assets/pai.png'}" alt="AI"></div>
